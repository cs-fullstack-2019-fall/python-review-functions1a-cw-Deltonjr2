...
# 1.Create a printNumbers function to print integers from -25 to 20 to the console (print in the function)
result = ""
for i in range(-25,21, 1):
    result += str (i) + ""
print(result)

# 2. Create a function called checkPassword. Send two string variables to the checkPassword function to check if the strings are equal. Return true if they are equal and false if they are not equal. Print the function's return value.
